...
public class Lab3 {
    public static void main(String[] args) {
        ...
        new HourlyEmployee(1, "Jatin", "Teaching Assistant", 20.5, 40).displayInfo();
        new SalariedEmployee(2, "Ritesh", "Lecturer", 4000).displayInfo();
        new ExecutiveEmployee(3, "Manisha", "Head of Department", 8000, 15).displayInfo();
    }
}