public class Lab3Test {
    public static void main(String[] args) {
        ...
        employees[0] = new HourlyEmployee(1, "Jatin", "Teaching Assistant", 20.5, 40);
        
        //instantiate SalariedEmployee
        employees[1] = new SalariedEmployee(2, "Ritesh", "Lecturer", 4000.0);
        
        //instantiate ExecutiveEmployee
        employees[2] = new ExecutiveEmployee(3, "Manisha", "Head of Department", 8000.0, 15.0);
